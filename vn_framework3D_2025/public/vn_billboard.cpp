...
void vnBillboard::setVertexPosition()
{
	...
	//vnDebugDraw::Line(&v[0], &v[1], 0xffff00ff);	//AARRGGBB
	//vnDebugDraw::Line(&v[1], &v[3], 0xffff00ff);
	//vnDebugDraw::Line(&v[3], &v[2], 0xffff00ff);
	//vnDebugDraw::Line(&v[2], &v[0], 0xffff00ff);
}
