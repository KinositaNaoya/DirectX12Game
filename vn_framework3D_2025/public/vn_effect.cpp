...
void vnEmitter::execute()
{
	...
	for (int i = 0; i < vnPARTICLE_MAX; i++) {
		...
		vtx[renderParticleNum * 4 + 0].x = XMVectorGetX(v[0]);
		vtx[renderParticleNum * 4 + 0].y = XMVectorGetY(v[0]);
		vtx[renderParticleNum * 4 + 0].z = XMVectorGetZ(v[0]);
		vtx[renderParticleNum * 4 + 1].x = XMVectorGetX(v[1]);
		vtx[renderParticleNum * 4 + 1].y = XMVectorGetY(v[1]);
		vtx[renderParticleNum * 4 + 1].z = XMVectorGetZ(v[1]);
		vtx[renderParticleNum * 4 + 2].x = XMVectorGetX(v[2]);
		vtx[renderParticleNum * 4 + 2].y = XMVectorGetY(v[2]);
		vtx[renderParticleNum * 4 + 2].z = XMVectorGetZ(v[2]);
		vtx[renderParticleNum * 4 + 3].x = XMVectorGetX(v[3]);
		vtx[renderParticleNum * 4 + 3].y = XMVectorGetY(v[3]);
		vtx[renderParticleNum * 4 + 3].z = XMVectorGetZ(v[3]);
