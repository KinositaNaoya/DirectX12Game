...
//メッシュデータ(先頭アドレス)の取得
vnModel_MeshData *vnModel::getMesh()const
{
...
//頂点データ(先頭アドレス)の取得
vnVertex3D *vnModel::getVertex()const
{
	if (!pModelData)return NULL;
