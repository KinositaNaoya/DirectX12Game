...
public:
	...
	//透明度の設定
	void setAlpha(float Vel);

	//幅の設定
	void setWidth(float Vel);

	void setUVRange(float left, float right);
	...
	void addWidth(float Vel);
	void addAlpha(float Vel);
};